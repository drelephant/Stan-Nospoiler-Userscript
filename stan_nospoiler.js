...
//         }
    ...
    function init() {
        ...
        backfive.classList.add('vjs-button','vjs-control','backfive');
        ...
        toggle.onclick = evt => {
            show = !show;
            if (show) {
                document.documentElement.classList.remove('hide-timeline');
            } else {
                document.documentElement.classList.add('hide-timeline');
            }
        }
    ...
    waitForKeyElements (".attribute--runtime", killNode); // remove runtime from list of matches
    waitForKeyElements (".panel__meta", killNode); // remove runtime from list of matches
